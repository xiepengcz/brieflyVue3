...
function createVNode(type, props, children) {
    ...
    // 判断是否为一个slot children, 需要是 组件 和 children object
...
function effect(fn, options = {}) {
    ...
    _effect.run();
    const runner = _effect.run.bind(_effect); // 这里存在this指向 使用bind修改this指向
